<template>
  <div class="flex flex-col-reverse md:grid md:grid-cols-12 gap-4">
    <Box class="md:col-span-7 flex items-center w-full">
      ...
      <div v-if="!listing.images.length" class="w-full text-center font-medium text-gray-500">No images</div>
    </Box>
...
import OfferMade from '@/Pages/Listing/Index/Components//OfferMade.vue'
