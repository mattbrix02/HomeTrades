...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\GSA\KM\public\storage' => 'string',
            'ldap.default' => 'string',
            ...
            'ldap.connections.default.use_starttls' => 'boolean',
            'ldap.connections.default.use_sasl' => 'boolean',
            'ldap.connections.default.sasl_options' => 'array',
            'ldap.logging.enabled' => 'boolean',
            'ldap.logging.channel' => 'string',
            'ldap.logging.level' => 'string',
            'ldap.cache.enabled' => 'boolean',
            'ldap.cache.driver' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\xampp\\htdocs\\GSA\\KM\\public\\storage','ldap.default',
...
'ldap.connections.default.timeout','ldap.connections.default.use_tls','ldap.connections.default.use_starttls','ldap.connections.default.use_sasl','ldap.connections.default.sasl_options',
'ldap.logging.enabled','ldap.logging.channel','ldap.logging.level','ldap.cache.enabled','ldap.cache.driver',
...
'index.index','index.show','courses.index','courses.create','courses.store',
'courses.show','courses.edit','courses.update','courses.destroy',);
...
'ldap::errors.user_not_found','ldap::errors.user_not_permitted_at_this_time','ldap::errors.user_not_permitted_to_login','ldap::errors.password_expired','ldap::errors.account_disabled',
'ldap::errors.account_expired','ldap::errors.user_must_reset_password','ldap::errors.user_account_locked',);
...
'DB_USERNAME','DB_PASSWORD','DB_COLLATION','LDAP_HOST','LDAP_PORT',
'LDAP_USE_SSL','LDAP_USE_TLS','LDAP_BASE_DN','LDAP_USERNAME','LDAP_PASSWORD',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','ASSET_URL',);
